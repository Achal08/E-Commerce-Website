...
<head>
        ...
        <title>About us | BookWorm Store</title>
...
<div class="container" id="content">
    <img src="img/about-img.jpg" style="float: left;" width="360" height="300">
    <div class="row">
        <div class="col-lg-4" align="justify">
            <h3><mark>WHO WE ARE</mark></h3><br>
            <p id="p1">BookWorm online Book store is a recognized leader in the ecommerce industry, with a steadfast commitment to success and a record of achievement that continues a tradition of delivering excellence.<br><br>The company was founded in 2020 by Achal Vaidya to ease the process of ordering various books. From those early days with just one employee, BookWorm Store now has more than 10000 employees, serving thousands of customers. <br><br>BookWorm Store is guided by four principles: customer obsession rather than competitor focus, passion for invention, commitment to operational excellence, and long-term thinking.<br><br><h4><mark>Vision</mark></h4>To make the world a more intelligent, self-aware and happier place.<br><br><h4><mark>Mission</mark></h4>We strive to offer our customers the lowest possible prices, the best available selection, and the utmost convenience.
            </p>
        </div>
        <div class="col-lg-4" align="justify">
